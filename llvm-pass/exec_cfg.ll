...
@CFG_LENGTH = dso_local global i32 20, align 4
...
@CFG_TABLE.1 = constant [20 x i32*] [i32* inttoptr (i32 13578929 to i32*), i32* bitcast (void (i32)* @_Z5CallFi to i32*), i32* inttoptr (i32 13578929 to i32*), i32* bitcast (void (i32)* @_Z5CallDi to i32*), i32* inttoptr (i32 13578929 to i32*), i32* bitcast (void (i32)* @_Z5CallGi to i32*), i32* inttoptr (i32 53415718 to i32*), i32* bitcast (void (%class.Hello*)* @_ZN5Hello5ptofnEv to i32*), i32* inttoptr (i32 53415718 to i32*), i32* bitcast (void (%class.Hello*)* @_ZN5Hello5vFuncEv to i32*), i32* inttoptr (i32 523159351 to i32*), i32* bitcast (void ()* @cfi_init to i32*), i32* inttoptr (i32 523159351 to i32*), i32* bitcast (void ()* @_Z5CallEv to i32*), i32* inttoptr (i32 523159351 to i32*), i32* bitcast (void ()* @cfi_free to i32*), i32* inttoptr (i32 523159351 to i32*), i32* bitcast (void ()* @_Z5CallAv to i32*), i32* inttoptr (i32 523159351 to i32*), i32* bitcast (void ()* @_Z5CallIv to i32*)]
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [20 x i32*], [20 x i32*]* @CFG_TABLE.1, i64 0, i64 %2
  %3 = load i32*, i32** %arrayidx, align 8
  %4 = ptrtoint i32* %3 to i64
  %5 = load i64, i64* %i, align 8
  %add = add i64 %5, 1
  %arrayidx2 = getelementptr inbounds [20 x i32*], [20 x i32*]* @CFG_TABLE.1, i64 0, i64 %add
