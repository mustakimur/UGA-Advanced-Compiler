...
@CFG_TABLE.1 = constant [0 x i32*] zeroinitializer
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [0 x i32*], [0 x i32*]* @CFG_TABLE.1, i64 0, i64 %2
  %3 = load i32*, i32** %arrayidx, align 8
  %4 = ptrtoint i32* %3 to i64
  %5 = load i64, i64* %i, align 8
  %add = add i64 %5, 1
  %arrayidx2 = getelementptr inbounds [0 x i32*], [0 x i32*]* @CFG_TABLE.1, i64 0, i64 %add
